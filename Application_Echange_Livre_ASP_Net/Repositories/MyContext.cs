...
namespace Application_Echange_Livre_ASP_Net.Repositories
{
    public class MyContext : DbContext
    {
        // Votre contexte a été configuré pour utiliser une chaîne de connexion « MyContext » du fichier 
        // de configuration de votre application (App.config ou Web.config). Par défaut, cette chaîne de connexion cible 
        // la base de données « Application_Echange_Livre_ASP_Net.Repositories.MyContext » sur votre instance LocalDb. 
        // 
